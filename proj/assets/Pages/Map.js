              ...
              <ScrollView>
                ...
                <View style={styles.taskContainer}>
                  <View style={styles.taskCard}>
                    ...
                    <ProgressBar progress={0.7} width={200} height={10} color={'#A2B29F'} />
                  ...
                  <View style={styles.taskCard}>
                    ...
                    <ProgressBar progress={0.2} width={200} height={10} color={'#A2B29F'} />
                  ...
                  <View style={styles.taskCard}>
                    ...
                    <ProgressBar progress={0} width={200} height={10} color={'#A2B29F'} />
          ...
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
            ...
            {businessDetails && (
              <ScrollView>
                ...
                <Text style={{ fontSize: 32, textAlign: 'left', marginBottom: 10, fontWeight: 'bold', color: '#A2B29F' }}>{businessDetails.name}</Text>
                ...
                <TouchableOpacity onPress={() => Linking.openURL(businessDetails.reviews_link)}>
                  <Text style={{ color: '#A2B29F', fontSize: 16, marginBottom: 10 }}>Read Reviews</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={() => Linking.openURL(businessDetails.website)} style={{ marginTop: 20, backgroundColor: '#A2B29F', borderRadius: 10, paddingVertical: 10 }}>
        ...
        <View style={styles.taskButtonContainer}>
          <TouchableOpacity
            ...
            <Svg width="64" height="64" viewBox="0 0 83 83" fill="none" xmlns="http://www.w3.org/2000/svg">
              <Path d="M83 41.5C83 64.4198 64.4198 83 41.5 83C18.5802 83 0 64.4198 0 41.5C0 18.5802 18.5802 0 41.5 0C64.4198 0 83 18.5802 83 41.5Z" fill="#7fbd73"/>
